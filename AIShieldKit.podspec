...
rate limiting, and in-memory caching.
  ...
  s.homepage         = 'https://github.com/NativesWave/AIShieldKit'
  s.readme           = 'https://raw.githubusercontent.com/NativesWave/AIShieldKit/main/README.md'
  s.documentation_url = 'https://github.com/NativesWave/AIShieldKit#readme'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Ahsan Iqbal' => '58457086+Ahsan-Pitafi@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/NativesWave/AIShieldKit.git', :tag => s.version.to_s }
